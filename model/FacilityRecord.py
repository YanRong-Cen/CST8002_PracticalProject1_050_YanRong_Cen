...
class StandardFacilityRecord(BaseRecord):
    ...
    def format_record(self):
        """
        Format the record in a standard comma-separated format.
        
        Returns:
            str: A comma-separated string containing all record details.
        """
        return (f"Region: {self.region}, District: {self.district}, License #: {self.license_number}, "
                f"Facility Name: {self.facility_name}, Type: {self.facility_type}, "
                f"Address: {self.facility_address_1}, {self.facility_address_2}, {self.facility_address_3}, "
...
class CompactFacilityRecord(BaseRecord):
    ...
    def format_record(self):
        """
        Format the record in a compact single-line format.
        
        Returns:
            str: A compact string containing essential record details.
        """
...
class DetailedFacilityRecord(BaseRecord):
    ...
    def format_record(self):
        """
        Format the record in a detailed multi-line format.
        
        Returns:
            str: A detailed multi-line string containing all record details.
        """
        return f"""
Facility Details:
----------------
...
Location: {self.region}, {self.district}

Address:
{self.facility_address_1}
{self.facility_address_2}
{self.facility_address_3}

Capacity Information:
- Total Children: {self.max_children}
- Infants: {self.max_infants}
- Preschool: {self.max_preschool}
- School Age: {self.max_school_age}

Additional Information:
- Language of Service: {self.language_of_service}
- Operator ID: {self.operator_id}
- Designated Facility: {self.designated_facility}
"""

# For backward compatibility, make FacilityRecord alias to StandardFacilityRecord
FacilityRecord = StandardFacilityRecord
